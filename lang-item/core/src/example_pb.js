...
proto.Example.toObject = function(includeInstance, msg) {
  var f, obj = {
    chinese: jspb.Message.getFieldWithDefault(msg, 1, ""),
    pinyin: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * @return {string}
 */
proto.Example.prototype.getChinese = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.Example.prototype.setChinese = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional string pinyin = 2;
 * @return {string}
 */
proto.Example.prototype.getPinyin = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.Example.prototype.setPinyin = function(value) {
